 ...
 * {@link OnFinishTaskListener} interface
...
public class FinishTaskFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFinishTaskListener) {
            mListener = (OnFinishTaskListener) context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement OnFinishTaskListener");
        }
    }
    ...
    public interface OnFinishTaskListener {
        ...
        void onFinishTaskItemPosition(int position);
    }
}
